...
class GridlockMuZeroEvaluator(ISerialEvaluator):
    """
    Overview:
                    ...
                    for env_id, episode_timestep in timesteps.items():
                        ...
                        if episode_timestep.done:
                            ...
                            if 'max_score' in episode_timestep.info:
                                saved_info['max_score'] = episode_timestep.info['max_score']
                            if 'avg_score' in episode_timestep.info:
                                saved_info['avg_score'] = episode_timestep.info['avg_score']
                            # ADDED LOGGING METRICS [END]
