...
from gridlock.alphazero_config import get_config
...
def train_alphazero(
    ...
    assert create_cfg.policy.type in ['alphazero'], \
        f"train_alphazero requires alphazero policy. provided: {create_cfg.policy.type}"
...
if __name__ == "__main__":
    ...
    train_alphazero([main_config, create_config], seed=0, max_env_step=int(2e5))