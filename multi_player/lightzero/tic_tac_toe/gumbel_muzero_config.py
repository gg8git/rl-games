...
evaluator_env_num = 5
num_simulations = 30
update_per_collect = 50 # this or replay ratio
batch_size = 256
...
tictactoe_gumbel_muzero_config = dict(
    exp_name=f'data_muzero/tictactoe_gumbel_muzero_sp-mode_ns{num_simulations}_upc{update_per_collect}_rer{reanalyze_ratio}_seed0',
    env=dict(
