...
gridlock2_gumbel_muzero_config = dict(
    exp_name=f'data_varied_muzero/gridlock2_stochastic_muzero_ns{num_simulations}_upc{update_per_collect}_rer{reanalyze_ratio}_bs{batch_size}_seed0',
    env=dict(
        env_id=env_id,
        num_players=2,
...
def get_gridlock2_stochastic_config():
